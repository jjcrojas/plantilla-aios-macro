...
public class ComisionesSemestralQueryService {
    ...
    public BigDecimal leer411500(LocalDate fechaCorte, BigDecimal trm) {
        if (trm == null || trm.signum() == 0) {
            throw new IllegalArgumentException("La TRM debe ser distinta de cero para calcular la fila 51");
        }
        ...
        log.info("Semestral fila 51 query cuenta=411500 fechaCorte={} cierreAnterior={} corteAnterior={} trm={} sql=\"{}\"",
                fechaCorte, cierreAnterior, corteAnterior, trm, sql().replace("\n", " ").replaceAll("\\s+", " ").trim());
        ...
        log.info("Semestral fila 51 resultado cuenta=411500 valorUsd={} fechaCorte={} trm={}", result, fechaCorte, trm);
        return result;
    }
